...
namespace MMath
{
	inline bool Add(StackState* value1,StackState* value2)
{
	...
	if((IsNumber(value1) || IsBool(value1)) && (IsNumber(value2) || IsBool(value2))){
		...
		value1->str= MGc::CreateString(dest);	
		delete [] dest;
		return true;
	}
	...
	{
		vector<StackState>* _ss = (vector<StackState>*)(value1->parray);
	...
	if((IsNumber(value1) || IsBool(value1)) && IsArray(value2))
	{
		...
		vector<StackState>* _ss = (vector<StackState>*)(value2->parray);
...
inline bool Power(StackState* value1,StackState* value2)
{
	if((IsNumber(value1) || IsBool(value1)) && (IsNumber(value2) || IsBool(value2))){
		value1->v = M_NUMBER;
...
inline bool Sub(StackState* value1,StackState* value2)
{
	if((IsNumber(value1) || IsBool(value1)) && (IsNumber(value2) || IsBool(value2))){
			value1->v = M_NUMBER;
			value1->d-=value2->d;
...
inline bool Mul(StackState* value1,StackState* value2)
{
	if((IsNumber(value1) || IsBool(value1)) && (IsNumber(value2) || IsBool(value2))){
			value1->v = M_NUMBER;
			value1->d*=value2->d;
...
inline bool Div(StackState* value1,StackState* value2)
{
	if(value2->d==0)
	{
...
inline bool Mod(StackState* value1,StackState* value2)
{
	if(value2->d==0)
	{
